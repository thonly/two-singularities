...
| `editions/` | Each edition's compiled text: the narrator's labelled frame, the seats' words quoted exactly, and the author's replies. The reading copy at [book.thonly.org](https://book.thonly.org) is rendered from it | Before that edition is published |
